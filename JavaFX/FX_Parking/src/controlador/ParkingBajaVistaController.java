...
public class ParkingBajaVistaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //inhabilitamos poder escribir sobre los campos, serán de solo lectura excepto el número de plaza
        this.rdbOcupada_Si_Bajas.setDisable(true);
        this.rdbOcupada_No_Bajas.setDisable(true);
        this.txtNombreYApellidosBajas.setDisable(true);
        this.txtCuotaBajas.setDisable(true);
        this.txtTelefonoBajas.setDisable(true);
        this.rdbPagoAlDia_Si_Bajas.setDisable(true);
        this.rdbPagoAlDia_No_Bajas.setDisable(true);
        this.txtAnchoBajas.setDisable(true);
        this.txtLargoBajas.setDisable(true);
        this.rdbTipoCoche_Pequeño_Bajas.setDisable(true);
        this.rdbTipoCoche_Estandar_Bajas.setDisable(true);
        this.rdbTipoCoche_Grande_Bajas.setDisable(true);
        this.rdbAccesoPasillo_Si_Bajas.setDisable(true);
        this.rdbAccesoPasillo_No_Bajas.setDisable(true);
        this.txtNumeroMotos_Bajas.setDisable(true);
    }
    ...
    private void buscarBajas(ActionEvent event) {
        ...
        if (!esNumero(this.txtNumeroDePlazaBajas.getText())) {
            ...
            if (plaza == null) {
                ...
                //ocultamos la información del tipo de plaza específico
                this.lblTipoCocheBajas.setVisible(false);
                this.rdbTipoCoche_Pequeño_Bajas.setVisible(false);
                this.rdbTipoCoche_Estandar_Bajas.setVisible(false);
                this.rdbTipoCoche_Grande_Bajas.setVisible(false);
                ...
                this.lblNumeroMotos_Bajas.setVisible(false);
                this.txtNumeroMotos_Bajas.setVisible(false);
                //y mostramos la información de la plaza
                mostrarPlaza(plaza);
            }
        }
    }
    ...
    private void eliminarBajas() {
        ...
        if (this.rdbOcupada_Si_Bajas.isSelected() || this.rdbOcupada_No_Bajas.isSelected()) { //si se han mostrado los datos (se ha buscado y recuperado la plaza) podemos proceder con la baja
            ...
            listaPlazas = Main.getListaPlazas();
