...
public class ParkingAltaVistaController implements Initializable {
    ...
    @FXML
    private Slider sldAnchoAltas;
    @FXML
    private Slider sldLargoAltas;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //enlazamos los sliders con los campos texto correspondientes
        this.txtAnchoAltas.textProperty().bindBidirectional(this.sldAnchoAltas.valueProperty(), NumberFormat.getNumberInstance());
        this.txtLargoAltas.textProperty().bindBidirectional(this.sldLargoAltas.valueProperty(), NumberFormat.getNumberInstance());
