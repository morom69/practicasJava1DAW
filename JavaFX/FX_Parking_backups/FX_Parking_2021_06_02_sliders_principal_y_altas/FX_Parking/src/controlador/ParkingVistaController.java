...
public class ParkingVistaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.txtAncho.textProperty().bindBidirectional(this.sldAncho.valueProperty(), NumberFormat.getNumberInstance());
        this.txtLargo.textProperty().bindBidirectional(this.sldLargo.valueProperty(), NumberFormat.getNumberInstance());
